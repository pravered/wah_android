...
public class FbActivity extends TripBaseActivity implements FbActivityFragment.OnFragmentInteractionListener,
    ...
    public void onTripLoaded(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Facebook Posts");
