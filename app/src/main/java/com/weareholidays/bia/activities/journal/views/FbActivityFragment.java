 ...
 */
public class FbActivityFragment extends Fragment {
     ...
     */
    public static FbActivityFragment newInstance() {
        FbActivityFragment fragment = new FbActivityFragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public FbActivityFragment() {
    ...
    private class TripSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            args.putString(SOCIAL_TYPE, Source.FB);
