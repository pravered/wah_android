...
public class DeleteActivity extends TripBaseActivity implements TimeLineFragment.OnFragmentInteractionListener {
    private ViewPager tripViewPager;
    public static String SHOW_JOURNAL_DAY = "SHOW_JOURNAL_DAY";
    public static String FROM_DELETE = "FROM_DELETE";
    ...
    public void onTripLoaded(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Delete Posts");
    ...
    private void saveDelete() {
        new DeleteTask(tripOperations, timeLinesMap).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
        ...
        tripOperations.getTripFeatureImage(new TripAsyncCallback<String>() {
            ...
            //    background.setTag(target);
                ...
                if (!TextUtils.isEmpty(result)) {
                  //  Picasso.with(DeleteActivity.this).load(result).into(target);
                    Glide.with(DeleteActivity.this)
                            .load(result)
                            .asBitmap()
              ...
              //      Picasso.with(DeleteActivity.this)
    ...
    private class TripSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            args.putBoolean(FROM_DELETE, true);
    ...
    private class DeleteTask extends AsyncTask<Void, Void, Void> {
        ...
        public DeleteTask(TripOperations tripOperations, Map<Integer, DayTimeLine> timeLinesMap) {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            try {
                progressDialog = CenterProgressDialog.show(DeleteActivity.this, null, null, true);
            } catch (Exception e) {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                for (Integer dayOrder : days) {
                    ...
                    for (Timeline timeline : dayTimeLine.getDeletedTimeLines()) {
                        tripOperationsTask.deleteTimelineOnly(timeline);
                    }
                }
            } catch (Exception e) {
