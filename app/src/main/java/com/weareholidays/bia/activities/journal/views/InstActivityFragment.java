 ...
 */
public class InstActivityFragment extends Fragment {
     ...
     */
    public static InstActivityFragment  newInstance() {
        InstActivityFragment  fragment = new InstActivityFragment ();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public InstActivityFragment () {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_inst, container, false);
        setup(v);
        return v;
    }
    ...
    private class TripSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            args.putString(SOCIAL_TYPE, Source.INSTAGRAM);
