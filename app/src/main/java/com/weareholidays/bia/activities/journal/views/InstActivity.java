...
public class InstActivity extends TripBaseActivity implements InstActivityFragment.OnFragmentInteractionListener,
    ...
    public void onTripLoaded(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Instagram Posts");
