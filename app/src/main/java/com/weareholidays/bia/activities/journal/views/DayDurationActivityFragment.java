 ...
 */
public class DayDurationActivityFragment extends Fragment {
     ...
     */
    public static DayDurationActivityFragment newInstance() {
        DayDurationActivityFragment fragment = new DayDurationActivityFragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public DayDurationActivityFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_day_duration, container, false);
        setup(v);
        return v;
    }
    ...
    private void setup(View v) {
        ...
        tripTabs.getTabAt(itemSelected).select();
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            dayOrder = mListener.getDayOrder();
            itemSelected = mListener.getItemSelected();
