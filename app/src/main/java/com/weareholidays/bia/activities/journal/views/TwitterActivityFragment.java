...
public class TwitterActivityFragment extends Fragment {
     ...
     */
    public static TwitterActivityFragment newInstance() {
        TwitterActivityFragment fragment = new TwitterActivityFragment();
    ...
    private class TripSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            args.putString(SOCIAL_TYPE, Source.TWITTER);
