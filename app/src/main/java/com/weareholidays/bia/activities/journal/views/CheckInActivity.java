...
public class CheckInActivity extends TripBaseActivity implements CheckInActivityFragment.OnFragmentInteractionListener,
    ...
    public void onTripLoaded(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Check-Ins");
