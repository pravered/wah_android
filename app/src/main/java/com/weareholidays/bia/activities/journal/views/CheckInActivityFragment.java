 ...
 */
public class CheckInActivityFragment extends Fragment {
     ...
     */
    public static CheckInActivityFragment newInstance() {
        CheckInActivityFragment fragment = new CheckInActivityFragment();
